    ...
    query.once("value", (snapshot) => { //get list of days
        snapshot.forEach((day) => {
            day.forEach((data) => {
                ...
                var $dateContainer = "<div class='col-2'>" + log.date + "</div>";
                var $timeContainer = "<div class='col-2'>" + log.hour + ":" + log.minute + "</div>";
                var $bsContainer = "<div class='col-2'>" + log.bs + "</div>";
                var $bolusContainer = "<div class='col-2'>" + log.bolus + "</div>";
